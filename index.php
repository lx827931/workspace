...
root@ip-10-0-4-221:/var/www/html# vi index.php
root@ip-10-0-4-221:/var/www/html# vi index.php
root@ip-10-0-4-221:/var/www/html# cat index.php
<?php
// Handle form submission
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == 'send') {
    $name = htmlspecialchars($_POST['name']);
...
<main>
    ...
    switch ($page) {
        ...
        case 'home':
        default:
            echo '<h2>Welcome to KBSM INFOTECH Website</h2>
